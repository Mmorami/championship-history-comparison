-- 002_ranking_grain_change.sql
-- Change the grain of the leaderboard from team-level to season-team-level.

-- 1. Redefine the input view to include season_id and granular stats.
...
-- 2. Update the snapshot table schema.
